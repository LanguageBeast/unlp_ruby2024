...
class ProductosTest < ApplicationSystemTestCase
  ...
  test "should create producto" do
    ...
    fill_in "Fecha ultima modificacion", with: @producto.fecha_ultima_modificacion
    fill_in "Imagenes", with: @producto.imagenes
    fill_in "Nombre", with: @producto.nombre
    fill_in "Precio unitario", with: @producto.precio_unitario
    fill_in "Stock disponible", with: @producto.stock_disponible
